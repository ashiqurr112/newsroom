...
class DiscoveryView extends StatelessWidget {
  ...
  static const List<String> _groupB = ['The Guardian', 'The New York Times', 'Al Jazeera', 'The Independent', 'The Conversation', 'The Daily Star']; // Generally center-left/liberal/progressive leaning
